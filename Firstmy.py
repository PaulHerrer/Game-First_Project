...
human_turn = True
while len(free):
	tabla_de_posiciones(board)
	if human_turn:
		mete_movimiento(board)
...
tabla_de_posiciones(board)
if victor == 'you':
	print("¡Lo lograste, GANASTE!")
elif victor == 'me':
	print("¡Eres rid'iculo, yo gano!")
else:
	print("¡Empate!")